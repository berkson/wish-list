package com.berkson.wish.wishlist.infra.persistence.repository;
...
public interface MongoWishListRepository extends ReactiveMongoRepository<WishListDocument, String> {
