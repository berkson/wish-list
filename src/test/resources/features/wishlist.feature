Feature: Gerenciamento da Wishlist
  ...
  Scenario: Não pode adicionar produto duplicado a wishlist
    ...
    When o cliente "cliente-003" adiciona o produto "produto-001" à wishlist
    When o cliente "cliente-003" tenta adicionar o produto "produto-001" à wishlist
    Then a operação deve falhar com status 500
  ...
  Scenario: Remover um produto da wishlist
    ...
    When o cliente "cliente-005" adiciona o produto "produto-001" à wishlist
    When o cliente "cliente-005" adiciona o produto "produto-002" à wishlist
  ...
  Scenario: Não pode remover produto que não existe na wishlist
    ...
    When o cliente "cliente-006" adiciona o produto "produto-001" à wishlist
  ...
  Scenario: Recuperar todos os produtos da wishlist
    ...
    When o cliente "cliente-007" adiciona o produto "produto-001" à wishlist
    When o cliente "cliente-007" adiciona o produto "produto-002" à wishlist
    When o cliente "cliente-007" adiciona o produto "produto-003" à wishlist
